<button class="border px-3 py-2 rounded border-white my-2 mx-auto font-bold flex items-center space-x-3">
    <svg version="1.1" id="Capa_1" class="h-5" fill="whitesmoke" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 489.8 489.8" xml:space="preserve">
        <g>
            <g>
